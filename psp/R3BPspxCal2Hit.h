...
//    virtual void Reset();
  ...
  private:
    ...
    R3BPspxCalPar* fCal; /**< Parameter instance holding thresholds and gains for position correction */
    R3BPspxHitPar* fHitPar; /**< Parameter instance holding thresholds and gains for position correction */
    ...
    TGraphErrors *hEnergy[10][2][32];
    TGraphErrors *hEnergyCorr[10][2][32];
