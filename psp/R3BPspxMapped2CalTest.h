...
class R3BPspxMapped2CalTest : public FairTask
{
  public:
    /** Default Constructor **/
    R3BPspxMapped2CalTest();
    ...
    R3BPspxMapped2CalTest(const char* name, Int_t iVerbose);

    /** Destructor **/
    virtual ~R3BPspxMapped2CalTest();
  ...
  private:
    ...
    TClonesArray* fCalItems; /**< Arrays holding output (Cal) data */
    ...
    Int_t GainFactors[6][2][32][32] = {{{{0}}}};

    TH1F* hEnergy[10][2][32];
    TH1F* hEnergyCorr[10][2][32];

  public:
    ClassDef(R3BPspxMapped2CalTest, 1)
};
