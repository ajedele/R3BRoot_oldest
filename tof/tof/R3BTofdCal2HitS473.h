...
class R3BTofdCal2HitS473 : public FairTask
{
  ...
  public:
    ...
    /**
     * Method for setting beam energy used in calibration process
     */
    inline void SetCalEnergy(Double_t calE) { fCalEnergy = calE;  }
    /**
     * Method for setting beam energy used in current run
     */
    inline void SetBeamEnergy(Double_t beamE) { fBeamEnergy = beamE; }
    /**
