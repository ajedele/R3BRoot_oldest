 ...
 * M.Heil in May 2016
 * expanded for S473 by J.Simon in Nov 2021
 */
#ifdef __CINT__
...
class R3BTofdCal2HitParS473 : public FairTask
{
  ...
  public:
    ...
    /** 
     * Method for setting the low cutoff for ToT position parameter determination
     */
    inline void SetTofdToTLow(Double_t ToTLow){fTofdToTLow = ToTLow;}
    /** 
     * Method for setting the high cutoff for ToT position parameter determination
     */
    ...
    /**
     * Method for setting the multicut variable to determine if more than one hit per paddle is allowed per event
     */
    inline void SetTofdMultCut(bool b){fMultCut = b;}
    /**
     * Method for using smiley instead of double exponential
     */
    inline void SetTofdSmiley(bool b){fTofdSmiley = b;}
    /**
     * Fit Walk Pars
     */
    inline void DetermineWalkPar(bool b){fTofdWalk = b;}
    /**
     *	Sets (currently fixed) parameter values for the walk correction
     */
    virtual void setWalkPar();
    /**
     ...
     */
    virtual void calcToTOffset(Double_t low, Double_t high);

    /** 
     * Method for calculating light attenuation lambda
     */
    virtual void calcLambda(Double_t low, Double_t high);
    ...
    /**
     * Method for the position dependence of scintillator
     * */
    virtual void smiley(TH2F* histo, Double_t min, Double_t max, Double_t*);

    /** 
     * Fit for Walk Correction*
     */
    virtual void fitWalk(TH2F* histo, Double_t min, Double_t max, Double_t*);
  ...
  private:
    ...
    Int_t maxEvents;		/**< Number of maximal events. */
    Int_t fLastEvent;		/**< Counter of the number of events analysed.*/
