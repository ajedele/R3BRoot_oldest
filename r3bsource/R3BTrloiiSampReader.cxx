...
Bool_t R3BTrloiiSampReader::Read()
{
    ...
    else if (1 == fSNum && 2 == fSCNum)
    {
        ...
        {
	  LOG(WARNING)<<"SAMPLOSL and SAMPLOSH array size mismatch!";
            return kFALSE;
        }
        else
        {
    ...
    else if (2 == fSNum && 2 == fSCNum)
    {
        ...
        {
	  LOG(WARNING)<<"SAMPMSL and SAMPMSH array size mismatch!";
            return kFALSE;
        }
        else
        {
